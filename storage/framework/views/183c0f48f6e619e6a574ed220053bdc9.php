    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="d-flex justify-content-between align-items-center mb-4 smooth-transition">
                ...
                <a href="<?php echo e(route('activities.create')); ?>" class="btn btn-success btn-lg smooth-transition">
            ...
            <div class="card smooth-transition">
                <div class="card-body" id="activitiesContainer">
                    <?php echo $__env->make('frontOffice.pages.activities.partials.activity-list', ['activities' => $activities], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>

            <?php if(method_exists($activities, 'hasPages') && $activities->hasPages()): ?>
...
<form id="bulkDeleteForm" action="<?php echo e(route('activities.bulk-delete')); ?>" method="POST" style="display: none;">
    <?php echo csrf_field(); ?>
...
function performLiveSearch(searchTerm) {
    ...
    // Make AJAX request
    fetch(`<?php echo e(route('activities.search')); ?>?search=${encodeURIComponent(searchTerm)}`, {
        method: 'GET',
        headers: {
...
<?php echo $__env->make('frontOffice.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Education\Laravel\project\UrbanGreen\resources\views/frontOffice/pages/activities/index.blade.php ENDPATH**/ ?>