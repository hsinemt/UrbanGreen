...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('frontOffice/img/favicon.png')); ?>">
    <title><?php echo $__env->yieldContent('title', 'Ecozone'); ?></title>

    <!-- Styles -->
    <link rel="stylesheet" href="<?php echo e(asset('frontOffice/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontOffice/css/fontawesome.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontOffice/css/slick.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontOffice/css/odometer.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontOffice/css/light-gallerr.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontOffice/css/jquery-ui.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontOffice/css/animate.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontOffice/css/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontOffice/css/loginstyle.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontOffice/css/donations.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('frontOffice/css/auth-styles.css')); ?>">
...
<div class="cs_preloader">
    ...
    <div class="cs_preloader_shape"><img src="<?php echo e(asset('frontOffice/img/nature/about_shape_1.svg')); ?>" alt=""></div>
    <div class="cs_preloader_shape_2"><img src="<?php echo e(asset('frontOffice/img/nature/about_shape_2.svg')); ?>" alt=""></div>
</div>

<?php echo $__env->make('frontOffice.partials.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<main>
    <?php echo $__env->yieldContent('content'); ?>
</main>

<?php echo $__env->make('frontOffice.partials.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<!-- Scripts -->
<script src="<?php echo e(asset('frontOffice/js/jquery-3.6.0.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontOffice/js/jquery.slick.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontOffice/js/odometer.js')); ?>"></script>
<script src="<?php echo e(asset('frontOffice/js/YTPlayer.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontOffice/js/light-gallery.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontOffice/js/jquery-ui.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontOffice/js/ripples.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontOffice/js/gsap.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontOffice/js/wow.min.js')); ?>"></script>
<!-- Add Bootstrap 5 bundle (includes Popper) for dropdowns/modals/tooltips -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
<script src="<?php echo e(asset('frontOffice/js/main.js')); ?>"></script>
    ...
    <div class="cs_ai_widget_popup" id="aiWidgetPopup">
        ...
        <div class="cs_ai_widget_content">
            ...
            <div class="cs_ai_widget_footer">
                <a href="<?php echo e(route('chatbot.front.index')); ?>" class="btn btn-outline-primary btn-sm w-100">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function sendWidgetMessage(message) {
        ...
        // Envoyer la requête
        fetch('<?php echo e(route("chatbot.front.send")); ?>', {
            method: 'POST',
            headers: {
...
<?php /**PATH E:\Education\Laravel\project\UrbanGreen\resources\views/frontOffice/layouts/app.blade.php ENDPATH**/ ?>