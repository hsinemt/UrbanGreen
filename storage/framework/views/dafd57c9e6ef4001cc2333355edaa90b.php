<?php $__env->startSection('title', 'Resources - UrbanGreen'); ?>
        ...
        <div class="card-body p-24">
            ...
            <div class="table-responsive scroll-sm">
                <table class="table bordered-table sm-table mb-0">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $resources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <span class="text-md mb-0 fw-normal text-secondary-light">#<?php echo e($resource->id); ?></span>
                            </td>
                            <td>
                                <span class="text-md mb-0 fw-normal text-secondary-light"><?php echo e($resource->name); ?></span>
                            </td>
                            <td>
                                <span class="bg-info-focus text-info-main px-16 py-4 radius-4 fw-medium text-sm"><?php echo e($resource->type); ?></span>
                            </td>
                            <td>
                                <span class="bg-neutral-200 text-neutral-900 px-16 py-4 radius-4 fw-medium text-sm"><?php echo e($resource->quantity); ?></span>
                            </td>
                            <td>
                                <span class="text-md mb-0 fw-normal text-secondary-light"><?php echo e($resource->created_at->format('Y-m-d')); ?></span>
                            </td>
                            <td class="text-center">
                                <div class="d-flex align-items-center gap-10 justify-content-center">
                                    <button type="button"
                                            onclick="viewResource(<?php echo e($resource->id); ?>)"
                                    ...
                                    <button type="button"
                                            onclick="editResource(<?php echo e($resource->id); ?>)"
                                    ...
                                    <form action="<?php echo e(route('resource.destroy', $resource)); ?>"
                                          method="POST"
                                          class="d-inline"
            ...
            <?php if($resources->hasPages()): ?>
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mt-24">
                    <span>Showing <?php echo e($resources->firstItem()); ?> to <?php echo e($resources->lastItem()); ?> of <?php echo e($resources->total()); ?> entries</span>
                    <ul class="pagination d-flex flex-wrap align-items-center gap-2 justify-content-center">
                        <?php echo e($resources->links('pagination::bootstrap-4')); ?>
    ...
    <div class="modal fade" id="createResourceModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="createResourceForm" action="<?php echo e(route('resource.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Education\Laravel\project\UrbanGreen\resources\views/dashboard/components/resources/index.blade.php ENDPATH**/ ?>