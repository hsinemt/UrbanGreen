<?php $__env->startSection('title', $competition->exists ? 'Edit Competition' : 'Create Competition'); ?>
...
<?php $__env->startSection('content'); ?>
  <section class="cs_page_heading cs_bg_filed cs_center text-center cs_heading_bg" data-src="<?php echo e(asset('assets/img/page_heading_bg.jpg')); ?>">
    <div class="container">
      <h1 class="cs_fs_51 cs_white_color cs_mb_11"><?php echo e($competition->exists ? 'Edit Competition' : 'Create Competition'); ?></h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>">Home</a></li>
        <li class="breadcrumb-item"><a href="<?php echo e(route('competitions.index')); ?>">Competitions</a></li>
        <li class="breadcrumb-item active"><?php echo e($competition->exists ? 'Edit' : 'Create'); ?></li>
      </ol>
    </div>
  </section>
  ...
  <div class="container">
    <form action="<?php echo e($competition->exists ? route('competitions.update', $competition) : route('competitions.store')); ?>" method="POST">
      <?php echo csrf_field(); ?>
      <?php if($competition->exists): ?>
        <?php echo method_field('PUT'); ?>
      <?php endif; ?>

      <div class="cs_form_group cs_mb_20">
        <label class="cs_form_label cs_fs_18 cs_semibold cs_mb_10">Project</label>
        <select name="projet_id" class="cs_form_input <?php $__errorArgs = ['projet_id'];
...
unset($__errorArgs, $__bag); ?>" required>
          ...
          <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($project->id); ?>" <?php echo e(old('projet_id', $competition->projet_id) == $project->id ? 'selected' : ''); ?>>
      ...
      <div class="cs_form_group cs_mb_20">
        ...
        <div id="assocList" class="cs_card cs_style_1 cs_white_bg" style="max-height:260px; overflow:auto; padding:12px; border:1px solid #e9ecef; border-radius:10px;">
          ...
          <?php $__currentLoopData = $associations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assoc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <label class="cs_checkbox_label" data-name="<?php echo e(Str::lower($assoc->name)); ?>" style="display:flex; align-items:center; gap:10px; padding:6px 4px; cursor:pointer;">
              <input type="checkbox" name="association_ids[]" value="<?php echo e($assoc->id); ?>" <?php echo e(in_array($assoc->id, $selected) ? 'checked' : ''); ?>>
              <span class="cs_avatar" style="width:28px;height:28px;border-radius:50%;background:#e9f5ee;color:#197b4f;display:inline-flex;align-items:center;justify-content:center;font-weight:600;">
                <?php echo e(Str::of($assoc->first_name.' '.$assoc->last_name)->trim()->explode(' ')->map(fn($p)=>Str::substr($p,0,1))->take(2)->implode('')); ?>

              </span>
              <span><?php echo e($assoc->name); ?></span>
            </label>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <small>Select one or more associations allowed to participate</small>
        <?php $__errorArgs = ['association_ids'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="cs_form_group cs_mb_20">
        ...
        <input type="text" name="reward" class="cs_form_input <?php $__errorArgs = ['reward'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('reward', $competition->reward)); ?>" required>
      </div>

      <div class="cs_form_group cs_mb_20">
        <label class="cs_form_label cs_fs_18 cs_semibold cs_mb_10">Description</label>
        <textarea name="description" class="cs_form_input <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="5"><?php echo e(old('description', $competition->description)); ?></textarea>
      </div>

      <button type="submit" class="cs_btn cs_style_1"><?php echo e($competition->exists ? 'Update' : 'Create'); ?></button>
    </form>
  </div>
...
<?php echo $__env->make('frontOffice.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Education\Laravel\project\UrbanGreen\resources\views/frontOffice/pages/competitions/form.blade.php ENDPATH**/ ?>