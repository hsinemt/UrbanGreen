<?php $__env->startSection('title', 'Assistant IA - Conseils Plantes'); ?>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="cs_chatbot_avatar me-3">
                                    <img src="<?php echo e(asset('frontOffice/img/icons/plant-ai-icon.svg')); ?>" alt="Assistant IA" class="img-fluid">
                                </div>
                                <div>
...
<section class="cs_features_section cs_padding_100 cs_bg_filed" data-src="<?php echo e(asset('frontOffice/img/nature/features_bg.jpg')); ?>">
    <div class="container">
        <div class="row">
...
<?php echo $__env->make('frontOffice.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Education\Laravel\project\UrbanGreen\resources\views/frontOffice/pages/chatbot.blade.php ENDPATH**/ ?>