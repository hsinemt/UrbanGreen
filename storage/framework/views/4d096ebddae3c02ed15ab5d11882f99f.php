...
<?php $__env->startSection('content'); ?>
    ...
    <section class="cs_hero cs_style_1 cs_heading_bg cs_center cs_bg_filed" data-src="<?php echo e(asset('frontOffice/img/nature/hero_bg.jpg')); ?>">
        <div class="container">
            <div class="cs_hero_thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.25s">
                <div class="cs_hero_thumb_left"><img src="<?php echo e(asset('frontOffice/img/nature/park.jpg')); ?> "alt="Thumb"></div>
                <div class="cs_hero_thumb_right"><img src="<?php echo e(asset('frontOffice/img/nature/family.jpg')); ?> " alt="Thumb"></div>
            ...
            <div class="row cs_gap_y_50 cs_row_gap_60">
                <div class="col-lg-6">
                    <div class="cs_team cs_style_1">
                        <div class="cs_team_thumb"><img src="<?php echo e(asset('frontOffice/img/nature/hsine.jpg')); ?> " alt=""></div>
                ...
                <div class="col-lg-6">
                    <div class="cs_team cs_style_1">
                        <div class="cs_team_thumb"><img src="<?php echo e(asset('frontOffice/img/nature/firas.jpg')); ?> " alt=""></div>
                        <div class="cs_team_right">
                ...
                <div class="col-lg-6">
                    <div class="cs_team cs_style_1">
                        <div class="cs_team_thumb"><img src="<?php echo e(asset('frontOffice/img/nature/eya.jpg')); ?> " alt=""></div>
                        <div class="cs_team_right">
    ...
    <!-- End Team Section -->
    <!-- Start CTA Section -->
    <section class="cs_bg_filed text-center" data-src="<?php echo e(asset('frontOffice/img/nature/volunteer.jpg')); ?> ">
