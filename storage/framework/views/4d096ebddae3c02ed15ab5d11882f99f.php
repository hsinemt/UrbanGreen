...
<?php $__env->startSection('content'); ?>
    <!-- Start Hero Section -->
    <section class="cs_hero cs_style_1 cs_heading_bg cs_center cs_bg_filed" data-src="<?php echo e(asset('frontOffice/img/nature/hero_bg.jpg')); ?>">
        <div class="container">
            <div class="cs_hero_thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.25s">
                <div class="cs_hero_thumb_left"><img src="<?php echo e(asset('frontOffice/img/nature/hero_img_1.jpg')); ?> "alt="Thumb"></div>
                <div class="cs_hero_thumb_right"><img src="<?php echo e(asset('frontOffice/img/nature/hero_img_2.jpg')); ?> " alt="Thumb"></div>
                <div class="cs_rotate_text_box cs_bg_filed cs_center" data-src="<?php echo e(asset('frontOffice/img/nature/hero_rotate_text_bg.svg')); ?> ">
                    <img src="<?php echo e(asset('frontOffice/img/nature/hero_rotate_text.svg')); ?> " alt="">
                </div>
            </div>
    ...
    <section class="cs_half_bg_wrap">
        ...
        <div class="cs_half_bg_top cs_accent_bg cs_bg_filed" data-src="<?php echo e(asset('frontOffice/img/nature/service_bg.svg')); ?> "></div>
                    ...
                    <div class="cs_slider_wrapper">
                        <div class="cs_slide">
                            <div class="cs_iconbox cs_style_3 cs_shadow_1 cs_white_bg text-center">
                                <div class="cs_iconbox_icon cs_mb_28"><img src="<?php echo e(asset('frontOffice/img/nature/service_icon_1.svg')); ?> " alt=""></div>
                        ...
                        <div class="cs_slide">
                            <div class="cs_iconbox cs_style_3 cs_shadow_1 cs_white_bg text-center">
                                <div class="cs_iconbox_icon cs_mb_28"><img src="<?php echo e(asset('frontOffice/img/nature/service_icon_2.svg')); ?> "alt=""></div>
                        ...
                        <div class="cs_slide">
                            <div class="cs_iconbox cs_style_3 cs_shadow_1 cs_white_bg text-center">
                                <div class="cs_iconbox_icon cs_mb_28"><img src="<?php echo e(asset('frontOffice/img/nature/service_icon_3.svg')); ?> " alt=""></div>
                        ...
                        <div class="cs_slide">
                            <div class="cs_iconbox cs_style_3 cs_shadow_1 cs_white_bg text-center">
                                <div class="cs_iconbox_icon cs_mb_28"><img src="<?php echo e(asset('frontOffice/img/nature/service_icon_4.svg')); ?> "alt=""></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="cs_half_screen_right">
                        <div class="cs_half_screen_thumb cs_bg_filed" data-src="<?php echo e(asset('frontOffice/img/nature/faq_bg.jpg')); ?> "></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="cs_slider_wrapper">
                        <div class="cs_slide">
                            <div class="cs_card cs_style_1 cs_shadow_1">
                                <div class="cs_card_thumb"><img src="<?php echo e(asset('frontOffice/img/nature/donation_img_1.jpg')); ?> "alt=""></div>
                        ...
                        <div class="cs_slide">
                            <div class="cs_card cs_style_1 cs_shadow_1">
                                <div class="cs_card_thumb"><img src="<?php echo e(asset('frontOffice/img/nature/donation_img_2.jpg')); ?> " alt=""></div>
                                <div class="cs_card_info">
                        ...
                        <div class="cs_slide">
                            <div class="cs_card cs_style_1 cs_shadow_1">
                                <div class="cs_card_thumb"><img src="<?php echo e(asset('frontOffice/img/nature/donation_img_3.jpg')); ?> " alt=""></div>
                                <div class="cs_card_info">
    ...
    <section class="cs_half_bg_wrap">
        <div class="cs_height_145 cs_height_lg_75"></div>
        <div class="cs_half_bg_bottom cs_accent_bg cs_bg_filed" data-src="<?php echo e(asset('frontOffice/img/nature/testimonial_bg.svg')); ?> "></div>
        <div class="container">
            <div class="cs_slider cs_style_1 cs_slider_gap_24 cs_ptb_12">
                ...
                <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-variable-width="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="3" data-add-slides="3">
                    <div class="cs_slider_wrapper">
                        <div class="cs_slide">
                            <div class="cs_testimonial cs_style_1 cs_shadow_1 cs_white_bg">
                                <div class="cs_testimonial_avatar cs_mb_42">
                                    <img src="<?php echo e(asset('frontOffice/img/nature/avatar_img_1.png')); ?> " alt="Avatar">
                        ...
                        <div class="cs_slide">
                            <div class="cs_testimonial cs_style_1 cs_shadow_1 cs_white_bg">
                                <div class="cs_testimonial_avatar cs_mb_42">
                                    <img src="<?php echo e(asset('frontOffice/img/nature/avatar_img_2.png')); ?> " alt="Avatar">
                                    <div class="cs_testimonial_avatar_right">
                        ...
                        <div class="cs_slide">
                            <div class="cs_testimonial cs_style_1 cs_shadow_1 cs_white_bg">
                                <div class="cs_testimonial_avatar cs_mb_42">
                                    <img src="<?php echo e(asset('frontOffice/img/nature/avatar_img_3.png')); ?> " alt="Avatar">
                                    <div class="cs_testimonial_avatar_right">
    ...
    <section class="cs_shape_wrap">
        <div class="cs_height_145 cs_height_lg_75"></div>
        <div class="cs_shape cs_shape_position_2"><img src="<?php echo e(asset('frontOffice/img/nature/about_shape_1.svg')); ?> " alt=""></div>
        <div class="cs_shape cs_shape_position_3"><img src="<?php echo e(asset('frontOffice/img/nature/about_shape_2.svg')); ?> " alt=""></div>
        <div class="container">
            <div class="cs_section_heading cs_style_1 text-center">
            ...
            <div class="row cs_gap_y_50 cs_row_gap_60">
                <div class="col-lg-6">
                    <div class="cs_team cs_style_1">
                        <div class="cs_team_thumb"><img src="<?php echo e(asset('frontOffice/img/nature/team_member_1.jpg')); ?> " alt=""></div>
                ...
                <div class="col-lg-6">
                    <div class="cs_team cs_style_1">
                        <div class="cs_team_thumb"><img src="<?php echo e(asset('frontOffice/img/nature/team_member_2.jpg')); ?> " alt=""></div>
                        <div class="cs_team_right">
                ...
                <div class="col-lg-6">
                    <div class="cs_team cs_style_1">
                        <div class="cs_team_thumb"><img src="<?php echo e(asset('frontOffice/img/nature/team_member_3.jpg')); ?> " alt=""></div>
                        <div class="cs_team_right">
                ...
                <div class="col-lg-6">
                    <div class="cs_team cs_style_1">
                        <div class="cs_team_thumb"><img src="<?php echo e(asset('frontOffice/img/nature/team_member_4.jpg')); ?> " alt=""></div>
                        <div class="cs_team_right">
                            <p class="text-uppercase cs_accent_color cs_mb_1">VOLUNTEER</p>
    ...
    <!-- End Team Section -->
    <!-- Start CTA Section -->
    <section class="cs_bg_filed text-center" data-src="<?php echo e(asset('frontOffice/img/nature/cta_bg.jpg')); ?> ">
...
<?php echo $__env->make('frontOffice.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Education\Laravel\project\UrbanGreen\resources\views/frontOffice/pages/home.blade.php ENDPATH**/ ?>