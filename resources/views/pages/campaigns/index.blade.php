      ...
      <div class="row cs_gap_y_50">
        <div class="col-lg-6">
          <div class="cs_card cs_style_2 cs_type_2 cs_shadow_1 cs_white_bg">
            <div class="cs_card_thumb"><img src="{{ asset('assets/img/others/card_img_1.jpg') }}" alt="" class="w-100"></div>
        ...
        <div class="col-lg-6">
          <div class="cs_card cs_style_2 cs_type_2 cs_shadow_1 cs_white_bg">
            <div class="cs_card_thumb"><img src="{{ asset('assets/img/others/card_img_2.jpg') }}" alt="" class="w-100"></div>
            <div class="cs_card_info">
        ...
        <div class="col-lg-6">
          <div class="cs_card cs_style_2 cs_type_2 cs_shadow_1 cs_white_bg">
            <div class="cs_card_thumb"><img src="{{ asset('assets/img/others/card_img_3.jpg') }}" alt="" class="w-100"></div>
            <div class="cs_card_info">
