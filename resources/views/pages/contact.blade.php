      ...
      <div class="row cs_gap_y_30">
        <div class="col-lg-4">
          <div class="cs_iconbox cs_style_7">
            <div class="cs_iconbox_icon cs_center"><img src="{{ asset('assets/img/others/contact_icon_1.svg') }}" alt=""></div>
        ...
        <div class="col-lg-4">
          <div class="cs_iconbox cs_style_7">
            <div class="cs_iconbox_icon cs_center"><img src="{{ asset('assets/img/others/contact_icon_2.svg') }}" alt=""></div>
            <div class="cs_iconbox_info">
        ...
        <div class="col-lg-4">
          <div class="cs_iconbox cs_style_7">
            <div class="cs_iconbox_icon cs_center"><img src="{{ asset('assets/img/others/contact_icon_3.svg') }}" alt=""></div>
            <div class="cs_iconbox_info">
              <h3 class="cs_fs_28 cs_semibold cs_mb_10">Office Location</h3>
