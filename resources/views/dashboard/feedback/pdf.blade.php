...
<body>
    ...
    <div class="header">
        ...
        <p>Total Records: {{ $feedback->count() }}</p>
    </div>
        ...
        <div class="info-section">
            ...
            <div class="summary">
                <div class="summary-item">
                    <div class="value">{{ $feedback->count() }}</div>
                    <div class="label">Total Feedback</div>
                </div>
                <div class="summary-item">
                    <div class="value">{{ $feedback->where('status', 'active')->count() }}</div>
                    <div class="label">Active</div>
                </div>
                <div class="summary-item">
                    <div class="value">{{ $feedback->where('status', 'flagged')->count() }}</div>
                    <div class="label">Flagged</div>
                </div>
                <div class="summary-item">
                    <div class="value">{{ number_format($feedback->whereNotNull('rating')->avg('rating'), 1) }}</div>
                ...
                @foreach($feedback as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <span class="status-badge status-inactive">{{ ucfirst($item->status) }}</span>
                            @endif
                        </td>
                    </tr>
                @endforeach
    ...
    <div class="footer">
        <p>&copy; {{ now()->year }} UrbanGreen. All rights reserved.</p>
