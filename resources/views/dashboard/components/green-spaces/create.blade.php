            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Ajouter un Espace Vert</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Nouvel Espace Vert</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.green-spaces.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('surface') is-invalid @enderror" 
                                                   id="surface" name="surface" value="{{ old('surface') }}" required>
                                            @error('surface')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('type') is-invalid @enderror" 
                                                ...
                                                <option value="Square" {{ old('type') == 'Square' ? 'selected' : '' }}>Square</option>
                                                <option value="Terrasse" {{ old('type') == 'Terrasse' ? 'selected' : '' }}>Terrasse</option>
                                                <option value="Balcon" {{ old('type') == 'Balcon' ? 'selected' : '' }}>Balcon</option>
                                                <option value="Serre" {{ old('type') == 'Serre' ? 'selected' : '' }}>Serre</option>
                                            </select>
                                            @error('type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('availability') is-invalid @enderror" 
                                                ...
                                                <option value="1" {{ old('availability', '1') == '1' ? 'selected' : '' }}>Disponible</option>
                                                <option value="0" {{ old('availability') == '0' ? 'selected' : '' }}>Occupé</option>
                                            </select>
                                            @error('availability')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
