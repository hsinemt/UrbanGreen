...
@section('title', 'Create Activity - UrbanGreen')

@section('breadcrumb')
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Create Activity</h6>
...
@section('content')
    <div class="card h-100 p-0 radius-12">
        <div class="card-header border-bottom bg-base py-16 px-24">
            <h6 class="text-lg fw-semibold mb-0">Create New Activity</h6>
        </div>
        ...
        <div class="card-body p-24">
            ...
            <form action="{{ route('back.activities.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control radius-8 @error('title') is-invalid @enderror" 
                                   placeholder="e.g., Tree Planting" value="{{ old('title') }}" required>
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control radius-8 @error('description') is-invalid @enderror" 
                                      rows="4" placeholder="Describe the activity...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="num_persons" class="form-control radius-8 @error('num_persons') is-invalid @enderror" 
                                           placeholder="e.g., 5" value="{{ old('num_persons') }}" min="1" required>
                                    @error('num_persons')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="time_to_finish" class="form-control radius-8 @error('time_to_finish') is-invalid @enderror" 
                                   placeholder="e.g., 2" value="{{ old('time_to_finish') }}" min="1">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <small class="text-primary-light">Activities help organize environmental tasks</small>
                                    </li>
                                    <li class="d-flex align-items-center gap-2 mb-2">
                                        <iconify-icon icon="solar:users-group-linear" class="icon text-sm text-primary-600"></iconify-icon>
                                        <small class="text-primary-light">Specify how many people can participate</small>
                                    </li>
                                    <li class="d-flex align-items-center gap-2 mb-2">
                                        <iconify-icon icon="solar:clock-linear" class="icon text-sm text-primary-600"></iconify-icon>
                                        <small class="text-primary-light">Set estimated completion time</small>
                                    </li>
                                </ul>
                            </div>
                        </div>
