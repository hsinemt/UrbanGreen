...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <h6 class="fw-semibold mb-0">Edit Competition</h6>
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card h-100 p-0 radius-12">
            <div class="card-header border-bottom bg-base py-16 px-24">
                <h4 class="fw-semibold mb-0">Edit Competition: {{ $competition->reward }}</h4>
            </div>
            <div class="card-body p-24">
                <form action="{{ route('back.competitions.update', $competition) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control radius-8 @error('name') is-invalid @enderror" 
                                   name="name" value="{{ old('name', $competition->name) }}" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control radius-8 @error('partner_id') is-invalid @enderror" name="partner_id" required>
                                ...
                                @foreach($partners as $partner)
                                    <option value="{{ $partner->id }}" {{ old('partner_id', $competition->partner_id) == $partner->id ? 'selected' : '' }}>
                                        {{ $partner->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control radius-8 @error('reward') is-invalid @enderror" 
                                   name="reward" value="{{ old('reward', $competition->reward) }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control radius-8 @error('description') is-invalid @enderror" 
                                  ...
                                  placeholder="Describe the competition details, rules, and criteria...">{{ old('description', $competition->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                                ...
                                @foreach($associations as $association)
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" 
                                               ...
                                               {{ in_array($association->id, old('association_ids', $competition->associations->pluck('id')->toArray())) ? 'checked' : '' }}>
