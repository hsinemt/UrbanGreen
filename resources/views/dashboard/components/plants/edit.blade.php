            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Modifier la Plante</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Modifier la Plante: {{ $plant->nom }}</h5>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('nom') is-invalid @enderror" 
                                                   id="nom" name="nom" value="{{ old('nom', $plant->nom) }}" required>
                                            @error('nom')
                                            ...
                                            <select class="form-select @error('green_space_id') is-invalid @enderror" 
                                                ...
                                                @foreach($greenSpaces as $greenSpace)
                                                    <option value="{{ $greenSpace->id }}" 
                                                        {{ old('green_space_id', $plant->green_space_id) == $greenSpace->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control @error('date_plantation') is-invalid @enderror" 
                                                   id="date_plantation" name="date_plantation" 
                                                   value="{{ old('date_plantation', $plant->date_plantation->format('Y-m-d')) }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control @error('date_croissance_prevue') is-invalid @enderror" 
                                                   id="date_croissance_prevue" name="date_croissance_prevue" 
                                                   value="{{ old('date_croissance_prevue', $plant->date_croissance_prevue->format('Y-m-d')) }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('personne_plantation') is-invalid @enderror" 
                                                   id="personne_plantation" name="personne_plantation" 
                                                   value="{{ old('personne_plantation', $plant->personne_plantation) }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('milieu_croissance') is-invalid @enderror" 
                                                ...
                                                <option value="Intérieur" {{ old('milieu_croissance', $plant->milieu_croissance) == 'Intérieur' ? 'selected' : '' }}>Intérieur</option>
                                                <option value="Extérieur" {{ old('milieu_croissance', $plant->milieu_croissance) == 'Extérieur' ? 'selected' : '' }}>Extérieur</option>
                                                <option value="Serre" {{ old('milieu_croissance', $plant->milieu_croissance) == 'Serre' ? 'selected' : '' }}>Serre</option>
                                                <option value="Jardin" {{ old('milieu_croissance', $plant->milieu_croissance) == 'Jardin' ? 'selected' : '' }}>Jardin</option>
                                                <option value="Balcon" {{ old('milieu_croissance', $plant->milieu_croissance) == 'Balcon' ? 'selected' : '' }}>Balcon</option>
                                            </select>
