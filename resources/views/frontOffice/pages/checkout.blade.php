...
@section('content')
  <!-- Start Hero Section -->
  <section class="cs_page_heading cs_bg_filed cs_center text-center cs_heading_bg" data-src="as@extends('frontOffice.layouts.app')sets/img/page_heading_bg.jpg">
    <div class="container">
