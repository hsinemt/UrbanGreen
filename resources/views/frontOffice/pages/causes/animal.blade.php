...
@section('content')
  <!-- Start Hero Section (from template/animal.html) -->
  <section class="cs_hero cs_style_2 cs_heading_bg cs_center">
    <div class="cs_hero_bg_left cs_bg_filed cs_accent_bg" data-src="{{ asset('assets/img/animal/hero_bg_pattern.svg') }}"></div>
    <div class="cs_hero_bg_right cs_bg_filed cs_accent_bg" data-src="{{ asset('assets/img/animal/hero_bg.jpg') }}"></div>
    <div class="container">
      <div class="cs_hero_in">
        <a href="https://www.youtube.com/embed/rRid6GCJtgc" class="cs_video_block cs_style_1 cs_bg_filed cs_video_open wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.25s" data-src="{{ asset('assets/img/animal/hero_img.jpg') }}">
        ...
        <div class="cs_hero_text wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.25s">
          <h2 class="cs_accent_color cs_fs_21 cs_mb_16">Wildlife Warriors</h2>
          <h1 class="cs_hero_title cs_fs_70 cs_white_color cs_mb_30">Advocating for Animals and Nature</h1>
  ...
  <!-- Start About Section (from template/animal.html) -->
  <section>
    ...
    <div class="container">
      <div class="row align-items-center cs_gap_y_50">
        ...
        <div class="col-lg-6">
          <div class="cs_layer_img_box">
            <div class="cs_layer_img_1">
              <img src="{{ asset('assets/img/animal/about_img_1.jpg') }}" alt="" class="cs_shadow_1">
            </div>
            <div class="cs_layer_img_2">
              <img src="{{ asset('assets/img/animal/about_img_2.jpg') }}" alt="">
            </div>
          </div>
        </div>
      </div>
