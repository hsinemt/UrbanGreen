                ...
                <div class="card-body">
                    <form action="{{ route('activities.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" required placeholder="Enter activity title...">
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" placeholder="Enter activity description...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $error }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('time_to_finish') is-invalid @enderror" id="time_to_finish" name="time_to_finish" value="{{ old('time_to_finish') }}" min="1" placeholder="Enter estimated hours...">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('num_persons') is-invalid @enderror" id="num_persons" name="num_persons" value="{{ old('num_persons', 1) }}" min="1" required placeholder="Enter number of people...">
                            @error('num_persons')
                                <div class="invalid-feedback">{{ $error }}</div>
                            @enderror
                        </div>
